...
`,
			Down: `DROP TABLE IF EXISTS settlements;`,
		},
	}
}
...
// producing logs/10_migration.log at runtime.
var _ = func() bool { flog.For("10_migration").Info("source file initialized"); return true }()
